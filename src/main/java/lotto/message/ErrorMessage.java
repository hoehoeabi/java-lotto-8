...
public final class ErrorMessage {
    ...
    public static final String INVALID_PURCHASE_AMOUNT_UNIT = ERROR_PREFIX + "구입 금액은 " + LottoConstants.LOTTO_PRICE + "원 단위여야 합니다.";
    public static final String INVALID_NUMBER_FORMAT = ERROR_PREFIX + "숫자를 입력해야 합니다.";
    public static final String CANNOT_BE_ZERO = "0은 입력할 수 없습니다.";
    ...
    public static final String BONUS_NUMBER_CONTAINS_IN_LOTTO = ERROR_PREFIX + "보너스 번호는 로또 번호에 포함되면 안됩니다.";
}
